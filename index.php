      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Eldorift Car Hire.</h1>
            <p>We strive to provide car rental services to the Eldorift region. </p>
             </div>
        </div>
      </div>
    </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Eldorift offers <span>the best vehicles for you</span></h2>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab"> View our Cars </a></li>
        </ul>
      </div>
